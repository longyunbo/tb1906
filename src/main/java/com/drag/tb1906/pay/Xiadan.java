...
import com.drag.tb1906.pay.common.Configure;
import com.drag.tb1906.pay.common.HttpRequest;
import com.drag.tb1906.pay.common.RandomStringGenerator;
import com.drag.tb1906.pay.common.Signature;
import com.drag.tb1906.pay.model.OrderInfo;
import com.drag.tb1906.pay.model.OrderReturnInfo;
import com.drag.tb1906.utils.IpUtils;
...
public class Xiadan {
	...
	public static JSONObject wxPay(HttpServletRequest request,String openid,int price) {
		...
		try {
			...
			order.setNotify_url("https://zlj.wisdomdr.com/tb1906/pay/payresult");
